...
import { Form, Input, Button, notification, Icon, Typography, Card } from 'antd';
        ...
        return (
            <div className="signup-container">
                 <div className="signup-body">
                    ...
                    <Title level={3} textALign="center" type="secondary">JTI-Polinema - Research Data Portal</Title>
                    <Card bordered={false} style={{ width: 400 }}>
                        <div className="signup-content">
                            <Form onSubmit={this.handleSubmit} className="signup-form">
                                ...
                                <FormItem
                                    validateStatus={this.state.passwordConfirmed.validateStatus}
                                    help={this.state.passwordConfirmed.errorMsg}>
                                    <Input
                                        size="large"
                                        ...
                                        autoComplete="off"
                                        placeholder="A password between 6 to 20 characters"
                                        value={this.state.passwordConfirmed.value}
